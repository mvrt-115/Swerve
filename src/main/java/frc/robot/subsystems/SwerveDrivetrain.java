...
public class SwerveDrivetrain extends SubsystemBase {
  ...
  public SwerveDrivetrain() {
    ...
    simOdometry = new SwerveDriveOdometry(swerveKinematics, getRotation2d(), modulePositions);
    field = new Field2d();
  ...
  public void resetSimOdometry(Pose2d pose) {
    ...
    simOdometry.resetPosition(new Rotation2d(simulationData.getHeading()), modulePositions, pose);
    stopModules();
  }
