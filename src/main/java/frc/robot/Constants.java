...
public final class Constants {
    public static class SwerveDrivetrain {
        ...
        public static final int m_frontRightDriveID = 2;
        public static final int m_backLeftDriveID = 4;
        public static final int m_backRightDriveID = 6;
        
        public static final int m_frontLeftTurnID = 1;
        public static final int m_frontRightTurnID = 3;
        public static final int m_backLeftTurnID = 5;
